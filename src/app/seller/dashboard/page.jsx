...
const page = () => {
  return (
    <div className="px-5 mt-2 pt-3 pb-5 overflow-y-auto h-[calc(100vh-80px)]">
      ...
      <div className="bg-red-50 p-5 rounded-xl border border-red-100 flex items-center gap-4 shadow-sm mb-10">
        <div className=" bg-red-100 rounded-lg text-red-700 min-w-10 min-h-10 flex justify-center items-center">
          <span className="material-symbols-outlined leading-0">error</span>
        </div>
        <div>
          <p className="sm:text-lg text-base font-extrabold text-red-900 ">
            Urgent: Low Stock!
          </p>
          <p className="text-red-900/70 text-sm sm:text-base">
            3 items are running low. Take action now!
          </p>
        </div>
        <Link
          className="ml-auto text-red-700  font-semibold text-sm shrink-0"
          href="#"
        >
          View
        </Link>
