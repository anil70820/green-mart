...
const TopBar = ({ title = "Dashboard", onMenuClick }) => {
  ...
  return (
    <header
      ...
      bg-white dk:bg-[#1a2e1a]
      border-b border-gray-100 dk:border-gray-800 shadow-sm"
    >
      {/* Mobile Menu Button */}
      <button
        onClick={onMenuClick}
      ...
      {/* Page Title */}
      <h1 className="text-xl font-bold tracking-tight text-[#111811] dk:text-[#e0e6e0] hidden lg:block">
        {title}
      </h1>
      ...
      <div className="flex items-center gap-4 ml-auto">
        {/* Notifications */}
        <button
          className="relative p-2 rounded-full hover:bg-gray-100 dk:hover:bg-white/10 min-w-10 min-h-10 flex justify-center items-center
        ...
        <div className="flex items-center gap-3">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-semibold text-[#111811] dk:text-[#e0e6e0]">
              {user?.name}
            </p>
          ...
          <div className="w-10 h-10 rounded-full overflow-hidden border border-gray-200 dk:border-gray-700">
            <Dropdown
              trigger={
                <img
