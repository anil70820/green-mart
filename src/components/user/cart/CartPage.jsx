...
export default function CartPage() {
  ...
  return (
    <div className="py-10">
      <div className="container xl:max-w-285 xl:px-0 px-5 mx-auto">
          ...
          <div className="grid lg:grid-cols-[2fr,1fr] gap-6">
            ...
            {cart.length !== 0 && (
              <div className="bg-white rounded-3xl shadow-sm p-5 h-fit">
                ...
                <Link href="/checkout" className="mt-5 flex px-3 justify-center items-center w-full bg-green-600 hover:bg-green-700 text-white text-sm font-semibold py-3 rounded-full transition">
                  Proceed to Checkout
                </Link>
              </div>
            )}
