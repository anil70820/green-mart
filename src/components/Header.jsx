...
const Header = () => {
  ...
  const toggleMenu = () => {
    setIsOpen(!isOpen);
    document.body.classList.add(isOpen ? "!overflow-auto" : "max-md:!overflow-hidden")
  };
  return (
      ...
      <div className="container xl:max-w-[1140px] mx-auto xl:px-0 px-5 w-full">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <Cta
              onClick={() => setIsOpen(false)}
              className="sm:hidden mt-6 max-w-[173px] !h-[46px] w-full text-center bg-transparent !border-black !text-black border shadow-none hover:!border-green hover:!text-green"
            >
              Order Delivery
            </Cta>
          </div>
          <Cta
            onClick={() => setIsOpen(false)}
            className="max-sm:hidden max-w-[173px] !h-[46px] w-full text-center bg-transparent !border-black !text-black border shadow-none hover:!border-green hover:!text-green"
          >
            Order Delivery
          </Cta>
          <button
